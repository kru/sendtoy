...
int main(int argc, char **argv)
{
    ...
    nob_cmd_append(&cmd, "/W4", "/Zi", "/wd4100", "/wd4996", "/nologo", "/std:c11");
    nob_cmd_append(&cmd, "/DBLAKE3_NO_SSE2", "/DBLAKE3_NO_SSE41", "/DBLAKE3_NO_AVX2", "/DBLAKE3_NO_AVX512");
    ...
    // --- Libraries ---
#ifdef _MSC_VER
    nob_cmd_append(&cmd, "ws2_32.lib", "advapi32.lib", "user32.lib", "Mswsock.lib"); // user32 fallback if needed
#else
